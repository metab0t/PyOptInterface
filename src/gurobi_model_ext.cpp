...
NB_MODULE(gurobi_model_ext, m)
{
	...
	nb::class_<GurobiModel>(m, "RawModel")
	    ...
	    .def("get_model_raw_attribute_vector_double", &GurobiModel::get_model_raw_attribute_vector_double)
	    .def("get_model_raw_attribute_list_double", &GurobiModel::get_model_raw_attribute_list_double)
