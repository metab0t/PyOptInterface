...
NB_MODULE(copt_model_ext, m)
{
	...
	nb::class_<COPTModel, CommercialSolverBase>(m, "RawModel")
	    ...
	    .def("set_raw_parameter_int", &COPTModel::set_raw_parameter_int)
	    .def("set_raw_parameter_double", &COPTModel::set_raw_parameter_double)
	    .def("get_raw_parameter_int", &COPTModel::get_raw_parameter_int)
	    .def("get_raw_parameter_double", &COPTModel::get_raw_parameter_double)
