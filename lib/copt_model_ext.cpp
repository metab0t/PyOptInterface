...
#define BIND_F(f) .def(#f, &COPTModelMixin::f)
	nb::class_<COPTModelMixin, COPTModel>(m, "RawModel")
	    ...
	    .def("add_linear_constraint", &COPTModelMixin::add_linear_constraint, nb::arg("expr"),
	         nb::arg("sense"), nb::arg("rhs"), nb::arg("name") = "")
	    .def("add_linear_constraint", &COPTModelMixin::add_linear_constraint_from_var,
	         nb::arg("expr"), nb::arg("sense"), nb::arg("rhs"), nb::arg("name") = "")
	    .def("add_linear_constraint", &COPTModelMixin::add_linear_constraint_from_expr,
	         nb::arg("expr"), nb::arg("sense"), nb::arg("rhs"), nb::arg("name") = "")
	    .def("add_linear_constraint", &COPTModelMixin::add_linear_constraint_from_comparison,
	         nb::arg("con"), nb::arg("name") = "")
	    .def("add_quadratic_constraint", &COPTModelMixin::add_quadratic_constraint, nb::arg("expr"),
	         nb::arg("sense"), nb::arg("rhs"), nb::arg("name") = "")
	    .def("add_quadratic_constraint", &COPTModelMixin::add_quadratic_constraint_from_expr,
	         nb::arg("expr"), nb::arg("sense"), nb::arg("rhs"), nb::arg("name") = "")
	    .def("add_quadratic_constraint", &COPTModelMixin::add_quadratic_constraint_from_comparison,
	         nb::arg("con"), nb::arg("name") = "")
