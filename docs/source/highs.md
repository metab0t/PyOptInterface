...
You need to install HiGHS separately from the [HiGHS website](https://ergo-code.github.io/HiGHS/stable/installation/#Install-HiGHS). After installing the software, you need to ensure the shared library of HiGHS is in the system path.
